...
namespace RentalSystem2.Controllers
{
    public class EquipmentsController : Controller
    {
        ...
        public EquipmentsController(RentalSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ActivityType,Manufacturer,DailyRentalRate,SkillLevel,AmateurDiscount,Description,Season,Qualifications")] Equipment equipment)
        {
